...
class TestLintConfigPresent:
    ...
    def test_lint_stage_integration(self):
        ...
        src_dir = Path("extracta_app/src")
        assert src_dir.exists(), "Source directory 'extracta_app/src' not found"

        # Verify tests directory exists
        tests_dir = Path("extracta_app/tests")
        assert tests_dir.exists(), "Tests directory 'extracta_app/tests' not found"
